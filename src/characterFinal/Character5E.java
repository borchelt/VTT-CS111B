/**
 * a class that models a Rpg Character5E in a mechanical sense
 */
...
public class Character5E 
{
	...
	/**
         ...
         * @param profession the character's  profession (normally class but java wont like that)
         ...
         * @param wis the character's wisdom
         * @param cha the character's charisma
         * @param speed the character's movement speed
         * @param inspiration whether or not the character has inspiration
         * @param maxHealth the character's max health
         * @param health the character's current
         * @param tempHealth the character's temp health
         * @param aC the character's AC
         * @param inti the character's initiative bonus
         * @param gold the character's gold
         * @param deck the character's deck of abilities
         */
	public Character5E(String name, int level, String profession, String race, int str, int dex, int con, int intel,
	...
	/**
	 * models a weapon attack hitting a Character5E
	 * @param target the Character5E being hit
	 * @param weapon the weapon card being used
	 * @return a string describing the action, this method also does damage to the target
	 */
	public String weaponAttack(Character5E target, WeaponCard weapon)
	{
	...
	/**
	 * models a spell hitting a Character5E
	 * @param targets the targets of the spell
	 * @param spell the spell card being used
	 * @return a string describing the action, this method also does damage to the target
	 */
	public String spellAttack(ArrayList<Character5E> targets, SpellCard spell)
	{
        ...
        /**
         * models equipping an item that gives stat bonuses
         * @param item the item card
         * @return a string describing the action, this method also changes a characters stats
         */
	public String equip(ItemCard item)
	{
         ...
         * @return a string describing the action, this method also changes a characters stats
         */
        public String unequip(ItemCard item)
	{
		item.removeBuffs(this);
		return this.getName() + " unequips " + item.getname() + ", losing the following bonuses: " + item.getManipulationMap() + "\n";
	}
	
	/**
	 * models using a class ability that doesn't do damage, like a barbarians rage or a rangers sense
	 * @param targets
	 * @param abilityCard
	 ...
	 * TO BE FORMATTED
	 * the toString method
	 * @return a string containing all the stats of the Character5E
	 */
	@Override
	public String toString() {
            int totalHealth = health + tempHealth;
		return "Character5E~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\nname: " + name + " ~~~ level: " + level + " ~~~ class: " + profession + " ~~~  race: " + race
				+ "~~~~~\nSTR: " + str + " ~~ DEX: " + dex + " ~~ CON: " + con + " ~~ INT: " + intel + " ~~ WIS: " + wis + "~~ CHA:"
				+ cha + "\nprof bonus: " + prof + " ~~ speed:" + speed +  " ~~ initiative: " + inti + " ~~ inspiration:" + inspiration + "~~ AC: " + AC 
                                + "\nhealth: " + totalHealth +"/" + maxHealth +"\n\n"
                                + "[" + strSave + ", " + dexSave + ", " + conSave + ", " + intSave + ", " 
                                + wisSave + ", " + chaSave + "]\n\n"
